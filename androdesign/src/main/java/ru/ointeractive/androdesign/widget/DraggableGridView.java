  ...
  // https://github.com/thquinn/DraggableGridView/blob/master/src/com/animoto/android/views/DraggableGridView.java
  ...
  public class DraggableGridView extends ViewGroup implements View.OnTouchListener, View.OnClickListener, View.OnLongClickListener {
    ...
    protected List<Integer> newPositions = new ArrayList<> ();
    ...
    public DraggableGridView (Context context, AttributeSet attrs) {
      ...
      if (OS.SDK >= 7) setChildrenDrawingOrderEnabled (true);
      
      DisplayMetrics metrics = new DisplayMetrics ();
      ((Activity) context).getWindowManager ().getDefaultDisplay ().getMetrics (metrics);
      
      dpi = Graphic.getDensityDpi (metrics.density);
    ...
    public boolean onTouch (View view, MotionEvent event) {
      ...
      switch (action & /*MotionEvent.ACTION_MASK*/ 0xff) { // SUPPORT 5
