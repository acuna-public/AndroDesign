	...
	public class SplitPaneLayout extends ViewGroup {
		...
		private void extractAttributes (Context context, AttributeSet attrs) {
			...
			if (attrs != null) {
				...
				} else mSplitterDraggingDrawable = new PaintDrawable (0x88FFFFFF);
		...
		public interface Listener {
			...
			void onDragStart (Rect rect);
			void onDrag (Rect rect);
			void onDragStop (Rect rect, int position);
			
		}
		
		private Listener listener;
		
		public SplitPaneLayout setListener (Listener listener) {
				...
				switch (event.getAction ()) {
					...
					case MotionEvent.ACTION_DOWN: {
						...
						if (mSplitterRect.contains (x, y)) {
							...
							if (listener != null) listener.onDragStart (temp);
					...
					case MotionEvent.ACTION_MOVE: {
						...
						if (isDragging) {
							...
							if (listener != null) listener.onDrag (temp);
					...
					case MotionEvent.ACTION_UP: {
						...
						if (listener != null) listener.onDragStop (temp, mSplitterPosition);
						break;
