  ...
  */
  ...
  public class UI {
    ...
    public static boolean checkField (Context context, View title, View titleCheck, int errorMess) {
      return checkField (context, title, titleCheck, errorMess);
    }
    ...
    public static boolean checkField (View title, View titleCheck, String errorMess) {
      return checkField (title, titleCheck, errorMess);
    }
    ...
    public static boolean checkField (Context context, TextView title, View titleCheck, int errorMess, boolean forced) {
      return checkField (context, title, titleCheck, errorMess, forced);
    }
    ...
    public static boolean checkField (Context context, boolean error, View titleCheck, int errorMess) {
      return checkField (context, error, titleCheck, errorMess);
    }
    ...
    public static AlertDialog.Builder dialog (Activity activity, int style, String title, Object text, int posButtonTitle) {
      ...
      AlertDialog.Builder builder = dialogBuilder (activity, style, posButtonTitle == 0);
    ...
    public static AlertDialog dialog (final AlertDialog dialog, final DialogPosInterface listener, int posButtonTitle) {
      ...
      if (posButtonTitle > 0 && listener != null)
    ...
    public static AlertDialog dialog (Activity activity, int style, int title, int text, DialogNeuInterface listener, int posButtonTitle, int negButtonTitle, int neuButtonTitle) {
      return dialog (activity, style, activity.getString (title), activity.getString (text), listener, posButtonTitle, negButtonTitle, neuButtonTitle);
    }
		
	  public static AlertDialog dialog (Activity activity, int style, int title, Object text, DialogNeuInterface listener, int posButtonTitle, int negButtonTitle, int neuButtonTitle) {
		  return dialog (activity, style, activity.getString (title), text, listener, posButtonTitle,
		  negButtonTitle, neuButtonTitle);
	  }
    ...
    public static AlertDialog dialog (Activity activity, int style, String title, Object text) {
      return dialog (activity, style, title, text, null, 0);
    }
    ...
    public interface DialogViewNegAdapterListener {
      ...
      View onView (AlertDialog.Builder builder, View view, int position);
    ...
    public static AlertDialog dialog (final Activity activity, int style, int title, int layout, final int listLayout, final List<ListItem> items, final DialogViewNegAdapterListener listener, int posButtonTitle, int negButtonTitle) {
      return dialog (activity, style, activity.getString (title), layout, listLayout, items, listener, posButtonTitle, negButtonTitle);
    }
    
    public static AlertDialog dialog (final Activity activity, int style, String title, int layout, final int listLayout, final List<ListItem> items, final DialogViewNegAdapterListener listener, int posButtonTitle, int negButtonTitle) {
      
      final AlertDialog.Builder builder = dialog (activity, style, title, "", posButtonTitle, negButtonTitle, 0);
      ...
      ArrayAdapter<ListItem> adapter = new ArrayAdapter<ListItem> (activity, layout, items) {
        ...
        public View getView (int position, View view, @NonNull ViewGroup parent) {
          ...
          view = inflater.inflate (listLayout, parent, false);
          
          return listener.onView (builder, view, position);
    ...
    public static AlertDialog dialog (final AlertDialog dialog, final DialogViewNegAdapterListener listener, int posButtonTitle, int negButtonTitle) {
    ...
    public static AlertDialog dialog (Activity activity, int style, String title, int inflater, DialogViewNegInterface listener, int posButtonTitle, int negButtonTitle) {
      ...
      AlertDialog.Builder builder = dialog (activity, style, title, "", posButtonTitle, negButtonTitle, 0, false);
    ...
    private static AlertDialog dialog (final AlertDialog dialog, final DialogViewNegInterface listener, int posButtonTitle, int negButtonTitle, final View view) {
    ...
    public static AlertDialog dialog (Activity activity, int style, String title, int layout, String[] items, final DialogChoiseInterface listener) {
      ...
      if (Int.size (items) > 0) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<> (activity, layout, items);
    ...
    public static void eulaDialog (Activity activity, int style, int title, int layout, final int textId, final String text, final int checkboxId, final int checkbox, final int checkboxText, final DialogNeuInterface listener) {
      ...
      dialog (activity, style, title, layout, new DialogViewNegInterface () {
        ...
        public View onView (AlertDialog.Builder builder, View view) {
          ...
          textView = (TextView) view.findViewById (checkbox);
