  ...
  /*
   Created by Acuna on 13.12.2017
  ...
  */
  ...
  public class ViewPager extends ViewGroup {
    ...
    public int mCurItem = 0;   // Index of currently displayed page.
    private int mRestoredCurItem = -1;
    private Parcelable mRestoredAdapterState = null;
    private ClassLoader mRestoredClassLoader = null;
    private Scroller mScroller;
    //private ViewPagerAdapter.DataSetObserver mObserver;
    ...
    public void setAdapter (ViewPagerAdapter adapter) {
      ...
      if (mAdapter != null) {
        ...
        for (int i = 0; i < Int.size (mItems); i++) {
    ...
    void setCurrentItemInternal (int item, boolean smoothScroll, boolean always, int velocity) {
      ...
      if (!always && mCurItem == item && Int.size (mItems) != 0) {
        setScrollingCacheEnabled (false);
        return;
      }
      if (item < 0) {
    ...
    void dataSetChanged () {
      ...
      boolean needPopulate = Int.size (mItems) < 3 && Int.size (mItems) < mAdapter.getCount ();
      int newCurrItem = -1;
    ...
    void populate () {
      ...
      lastPos = Int.size (mItems) > 0 ? mItems.get (Int.size (mItems) - 1).position : -1;
      if (lastPos < endPos) {
        lastPos++;
    ...
    public void addFocusables (ArrayList<View> views, int direction, int focusableMode) {
      ...
      final int focusableCount = Int.size (views);
